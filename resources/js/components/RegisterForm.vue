...
<template>        
    <div id="register_form_container" class="p-5 relative my-5 mx-4 sm:mx-0 border rounded-md shadow-lg" :class="opacityClass">
        ...
        <form action="#" id="register_form" class="flex flex-col gap-y-4" @submit.prevent="handleRegister" :disabled="showLoadingSpinner">
            <!-- Name -->
            <div class="flex flex-col" id="name_container">
            ...
            <!-- Confirm Password -->
            <div class="flex flex-col" id="confirm_password_container">
