<!DOCTYPE html>
    ...
    <body>
        <h1 class="text-3xl font-bold mb-5">Test del candidato</h1>
        <p>Benvenuto/a nel test per la tua candidatura. </p>
        <p>Cosa puoi fare con questo progetto: </p>
        <ol>
        ...
        <p>Sei libero/a di scegliere uno o più di uno dei punti precedenti. </p>
        <p>Puoi anche cimentarti in qualcosa di completamente diverso,
